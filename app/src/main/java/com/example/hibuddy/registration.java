        ...
        rg_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(namee) || TextUtils.isEmpty(emaill) || TextUtils.isEmpty(Password) || TextUtils.isEmpty(cPassword)){
                    ...
                    progressDialog.dismiss();
                    rg_email.setError("Type Valid Email Here");
...
//                                                progressDialog.show();
                                    ...
                                    String status = "Hey i am using this application";
                                    imageuri = "https://firebasestorage.googleapis.com/v0/b/hi-buddy-5b46a.appspot.com/o/men_2.png?alt=media&token=73d51277-2cc0-4a3d-9e2b-9ef395aeb882";
                                    Users users = new Users(id,namee,emaill,Password,imageuri,status);
                                    reference.setValue(users).addOnCompleteListener(new OnCompleteListener<Void>() {
                                        @Override
                                        public void onComplete(@NonNull Task<Void> task) {
